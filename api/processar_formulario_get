...
<body>
    <main>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            $email = $_GET["campo_email"];
            $telefone = $_GET["campo_telefone"];
            $assunto = $_GET["campo_assunto"];
            $mensagem = $_GET["campo_mensagem"];
            $preferencia_contato = $_GET["campo_pref_contato"];
            $onde_encontrou = $_GET["campo_campus"];
            $opcoes = isset($_GET["opcoes"]) ? $_GET["opcoes"] : [];
